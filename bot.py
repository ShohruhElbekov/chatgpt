...
# 🔐 Telegram bot va TogetherAI ma'lumotlari
API_ID = 23346001
API_HASH = "08c63cda730a00374392062e09c426d1"
BOT_TOKEN = "8161140522:AAHHIJaLYmlPCsTJrInDxDRfKWTfzXaMDXI"  # ← o'zingizning bot tokeningizni yozing
TOGETHER_API_KEY = "10888df0044c2a80602f2b4238e376fdd95fc62a6ab824b265a074ff5b1b1fe9"  # ← bu yerga Together API kalit
TOGETHER_MODEL = "deepseek-ai/DeepSeek-V3"

# 👨‍💻 Admin foydalanuvchi ID
ADMIN_IDS = [7181480233]  # ← o'zingizning Telegram ID'ingizni yozing
...
def show_logs(client, message):
    ...
    with open("log.txt", "r", encoding="utf-8") as f:
        logs = f.readlines()[-30:]  # oxirgi 30ta savol
